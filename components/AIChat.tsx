...
const AIChat: React.FC = () => {
  ...
  // Fixed: Updated initial message to match the portfolio theme
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Hi! I am LUMI. Ask me anything about my projects, skills, or experience. ⚡️' }
  ]);
            ...
            <div className="p-3 border-t border-white/10 bg-black/40">
              <div className="flex gap-2">
                <input
                  ...
                  // Fixed: Updated placeholder text to match portfolio context
